        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-[#374151]/10 flex items-center justify-center shrink-0">
                <Building2 className="h-6 w-6 text-[#374151]" />
              </div>
              <div className="space-y-1.5">
                <p className="font-semibold text-gray-900">{entity.name}</p>
                {entity.email && (
                  <a href={`mailto:${entity.email}`} className="flex items-center gap-1.5 text-sm text-gray-600 hover:text-[#374151] transition-colors">
                    <Mail className="h-3.5 w-3.5" />{entity.email}
                  </a>
                )}
                {entity.phone && (
                  <a href={`tel:${entity.phone}`} className="flex items-center gap-1.5 text-sm text-gray-600 hover:text-[#374151] transition-colors">
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start gap-4">
                    <Avatar className="h-14 w-14">
                      <AvatarFallback className="bg-[#374151]/10 text-[#374151] font-bold text-lg">
                    ...
                    <div className="flex-1 min-w-0 space-y-2">
                      ...
                      <div className="space-y-1">
                        <a
                          ...
                          className="flex items-center gap-1.5 text-sm text-gray-600 hover:text-[#374151] transition-colors"
                        >
