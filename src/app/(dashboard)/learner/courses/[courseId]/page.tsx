  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <Loader2 className="h-10 w-10 text-[#3DB5C5] animate-spin" />
      </div>
    );
  }
      ...
      case "cover":
        return (
          <div className="flex flex-col items-center justify-center h-full text-center px-8 py-12">
            ...
            <Button
              onClick={goNext}
              className="bg-gradient-to-r from-[#3DB5C5] to-blue-600 text-white px-10 py-4 text-lg gap-3 rounded-2xl shadow-lg hover:shadow-xl transition-all"
            >
      ...
      case "gamma_chapter": {
        ...
        return (
          <div className="flex flex-col h-full">
            {/* Chapter header */}
            <div className="flex items-center justify-between px-6 py-3 bg-gradient-to-r from-[#3DB5C5]/10 to-blue-50 border-b border-[#3DB5C5]/20">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-[#3DB5C5] flex items-center justify-center text-white font-bold text-sm">
                  {screen.chapterIdx + 1}
                </div>
                <div>
            ...
            {hasGamma ? (
              ...
              <div className="flex-1 overflow-y-auto px-8 py-8">
                <div className="max-w-3xl mx-auto">
                  <div className="text-xs font-semibold text-[#3DB5C5] uppercase tracking-widest mb-2">
                  ...
                  {ch.key_concepts && ch.key_concepts.length > 0 && (
                    <div className="flex flex-wrap gap-2 mb-6">
                      {ch.key_concepts.map((c, i) => (
                        <span key={i} className="text-xs px-3 py-1 rounded-full bg-[#3DB5C5]/10 text-[#3DB5C5] font-medium">
                          {c}
                        </span>
                      ))}
                    </div>
            ...
            <div className="px-6 py-4 bg-white border-t border-gray-200 flex justify-end">
              <Button
                onClick={goNext}
                className="bg-gradient-to-r from-[#3DB5C5] to-blue-600 text-white px-8 py-3 text-base gap-2 rounded-xl shadow-md"
              >
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6">
              {questions.length > 0 ? (
                      ...
                      <div className="space-y-5">
                        ...
                        {!isRevealed ? (
                          ...
                          <Button
                            ...
                            className="w-full bg-[#3DB5C5] hover:opacity-90 text-white py-4 text-base rounded-xl gap-2 shadow-md"
                          >
                ...
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <Button onClick={goNext} className="mt-4 gap-2 bg-[#3DB5C5] text-white">
        ...
        return (
          <div className="flex flex-col items-center justify-center h-full px-8 text-center bg-gradient-to-br from-gray-50 to-white">
            <div className={cn(
              ...
              "bg-gradient-to-br from-blue-400 to-[#3DB5C5]"
            )}>
            ...
            <div className="relative w-40 h-40 mb-8">
              <svg className="w-40 h-40 -rotate-90" viewBox="0 0 160 160">
                ...
                <circle
                  cx="80" cy="80" r="66"
                  fill="none"
                  stroke={isPerfect ? "#eab308" : passed ? "#22c55e" : "#3DB5C5"}
                  strokeWidth="16"
                  strokeLinecap="round"
            ...
            <Button
              onClick={goNext}
              className="bg-gradient-to-r from-[#3DB5C5] to-blue-600 text-white px-10 py-4 text-base gap-3 rounded-2xl shadow-lg"
            >
        ...
        return (
          <div className="flex flex-col items-center justify-center h-full px-8 text-center bg-gradient-to-br from-gray-50 to-white">
            <div className={cn(
              ...
              passed ? "bg-gradient-to-br from-yellow-400 to-amber-500" : "bg-gradient-to-br from-blue-400 to-[#3DB5C5]"
            )}>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/learner">
                <Button className="bg-gradient-to-r from-[#3DB5C5] to-blue-600 text-white hover:opacity-90 gap-2 px-6 py-3 rounded-xl">
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isActive ? "bg-[#3DB5C5]/10 border-l-2 border-[#3DB5C5]" : "hover:bg-gray-50 border-l-2 border-transparent"
                    )}
                  >
                    <div className={cn(
                      "w-7 h-7 rounded-lg flex items-center justify-center text-xs font-bold shrink-0",
                      isDone ? "bg-green-100 text-green-700" :
                      isActive ? "bg-[#3DB5C5] text-white" :
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-4 shrink-0 z-10">
        ...
        <button
          ...
          className="flex items-center gap-1 text-gray-400 hover:text-[#3DB5C5] transition"
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-0.5">
            <div className="flex-1 bg-gray-200 rounded-full h-1.5 max-w-xs">
              <div
                className="bg-gradient-to-r from-[#3DB5C5] to-blue-600 h-1.5 rounded-full transition-all duration-500"
        ...
        {!hideBottomNav && (
          <div className="bg-white border-t border-gray-200 px-4 py-3 flex items-center justify-between shrink-0">
            ...
            {currentIdx < screens.length - 1 && (
              <Button
                onClick={goNext}
                className="gap-2 bg-[#3DB5C5] text-white hover:opacity-90 rounded-xl"
              >
