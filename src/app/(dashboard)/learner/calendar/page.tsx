                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          ...
                          isToday && "bg-blue-50/40",
                          isSelected && "ring-2 ring-[#3DB5C5] ring-inset"
                        )}
                      >
                        <span className={cn(
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base flex items-center gap-2">
              <Calendar className="h-4 w-4 text-[#3DB5C5]" />
                ...
                <div key={s.id} className="rounded-lg border p-4 space-y-2 hover:bg-gray-50/50 transition-colors">
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    <a
                      ...
                      className="inline-flex items-center gap-1 text-xs font-medium text-[#3DB5C5] hover:underline"
                    >
