...
export const QUICK_ACCESS = [
  { title: "Clients",       href: "/admin/clients",          icon: Building2,    color: "#374151" },
  { title: "Formations",    href: "/admin/trainings",         icon: BookOpen,     color: "#374151" },
  { title: "Sessions",      href: "/admin/sessions",          icon: Calendar,     color: "#374151" },
  { title: "Formateurs",    href: "/admin/trainers",          icon: UserCheck,    color: "#374151" },
  { title: "CRM",           href: "/admin/crm/prospects",     icon: TrendingUp,   color: "#374151" },
  { title: "Documents",     href: "/admin/documents",         icon: FileText,     color: "#374151" },
  { title: "Rapports",      href: "/admin/reports",           icon: BarChart3,    color: "#374151" },
  { title: "Emails",        href: "/admin/emails",            icon: Mail,         color: "#374151" },
  { title: "Signatures",    href: "/admin/signatures",        icon: PenLine,      color: "#374151" },
  { title: "Programmes",    href: "/admin/programs",          icon: ClipboardList,color: "#374151" },
  { title: "Questionnaires",href: "/admin/questionnaires",    icon: Settings,     color: "#374151" },
  { title: "Tâches CRM",   href: "/admin/crm/tasks",         icon: CheckCircle,  color: "#374151" },
];
