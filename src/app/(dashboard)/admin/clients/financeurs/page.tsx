...
export default function FinanceursPage() {
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex gap-2 mb-4">
        <div className="relative w-72">
          ...
          <input
            ...
            className="border border-gray-300 rounded-lg pl-9 pr-3 py-2 text-sm w-full focus:outline-none focus:border-[#374151]"
          />
        </div>
      </div>
      ...
      {/* Inline Add Form */}
      {showAddForm && (
        <div className="border border-[#374151] rounded-lg bg-white p-4 mb-4">
                      ...
                      <>
                        <td className="px-4 py-2">
                          <input
                            ...
                            className="w-full border border-gray-300 rounded px-2 py-1 text-sm focus:outline-none focus:border-[#374151]"
                          />
                        </td>
                        <td className="px-4 py-2">
                          <input
                        ...
                        <td className="px-4 py-2">
                          <select
                            ...
                            className="border border-gray-300 rounded px-2 py-1 text-sm focus:outline-none focus:border-[#374151]"
                          >
                            {TYPE_OPTIONS.map((t) => <option key={t} value={t}>{t}</option>)}
                          </select>
                        </td>
