              ...
              {articles.map((article, i) => (
                <div key={i} className="p-4 bg-muted/30 rounded-lg space-y-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm font-medium text-gray-900 hover:text-[#3DB5C5] transition-colors block"
                  >
                    {article.title}
                  ...
                  <div className="space-y-1 flex-1 min-w-0">
                    ...
                    {note.url && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-xs text-[#3DB5C5] hover:underline inline-flex items-center gap-1"
                      >
