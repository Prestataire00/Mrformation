  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center gap-2 text-sm mb-4">
        ...
        <Link href="/admin/reports" className="text-[#3DB5C5] hover:underline">Suivis</Link>
        <span className="text-gray-400">/</span>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4 mb-6">
        <div className="flex flex-wrap items-end gap-4">
          <div>
            ...
            <input type="date" value={dateFrom} onChange={(e) => setDateFrom(e.target.value)} className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#3DB5C5]" />
          </div>
          <div>
            <label className="block text-xs text-gray-500 mb-1">Date de fin</label>
            <input type="date" value={dateTo} onChange={(e) => setDateTo(e.target.value)} className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#3DB5C5]" />
          </div>
          <button className="text-white px-4 py-2 rounded-lg text-sm font-medium uppercase flex items-center gap-1" style={{ background: "#3DB5C5" }}>
                ...
                <tr key={item.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      <button onClick={() => setEditItem({ ...item })} className="text-[#3DB5C5] hover:underline text-xs font-medium">Modifier</button>
      ...
      <Dialog open={addOpen} onOpenChange={setAddOpen}>
        <DialogContent className="max-w-lg">
          ...
          <DialogFooter>
            ...
            <button onClick={handleAdd} className="text-white px-4 py-2 rounded-lg text-sm font-medium" style={{ background: "#3DB5C5" }}>Ajouter</button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={!!editItem} onOpenChange={() => setEditItem(null)}>
        <DialogContent className="max-w-lg">
          ...
          <DialogFooter>
            ...
            <button onClick={handleSaveEdit} className="text-white px-4 py-2 rounded-lg text-sm font-medium" style={{ background: "#3DB5C5" }}>Enregistrer</button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
