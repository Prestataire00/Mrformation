                  ...
                  <tr key={`${q.id}-expand`}>
                    <td colSpan={7} className="px-8 py-3 bg-gray-50/50 border-b">
                      {q.questions.length === 0 ? (
                        <p className="text-xs text-gray-400 italic">Aucune question — <button onClick={() => router.push("/admin/questionnaires")} className="text-[#374151] hover:underline">ajouter des questions</button></p>
                      ) : (
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-semibold text-gray-700 flex items-center gap-2">
              <Send className="h-4 w-4 text-[#374151]" />
