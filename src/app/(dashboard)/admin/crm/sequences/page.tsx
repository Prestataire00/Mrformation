  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button size="sm" onClick={openCreate} style={{ background: "#3DB5C5" }} className="text-white gap-1.5">
      ...
      {loading ? (
        ...
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <Button size="sm" onClick={openCreate} className="mt-4 gap-1.5" style={{ background: "#3DB5C5" }}>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSave} disabled={saving || !name.trim()} style={{ background: "#3DB5C5" }} className="text-white">
      ...
      <Dialog open={enrollOpen} onOpenChange={setEnrollOpen}>
        <DialogContent className="max-w-sm">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleEnroll} disabled={!selectedProspectId} style={{ background: "#3DB5C5" }} className="text-white">
              Inscrire
            </Button>
          </DialogFooter>
        </DialogContent>
