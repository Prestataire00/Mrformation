          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-full h-10 rounded-md border border-gray-200 bg-white px-3 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#374151]/30 focus:border-[#374151]"
              >
                {ACTION_TYPE_OPTIONS.map((t) => (
                  <option key={t} value={t}>
                    {ACTION_TYPE_CONFIG[t].label}
