  ...
  return (
    <div className="p-6 max-w-4xl">
      ...
      <div className="flex items-center gap-2 text-sm mb-4">
        ...
        <Link href="/admin/trainings" className="text-[#374151] hover:underline">Formations</Link>
        <span className="text-gray-400">/</span>
            ...
            {rules.map((rule, index) => (
              <div key={`${rule.trigger_type}-${rule.document_type}-${index}`} className="p-4 border border-gray-100 rounded-lg space-y-3">
                <div className="flex items-center gap-3">
                  <span className="w-6 h-6 rounded-full text-white text-xs flex items-center justify-center font-bold flex-shrink-0" style={{ background: "#374151" }}>
                    {index + 1}
                  </span>
                  <Switch
