/**
 * POST /api/documents/generate-avis-habilitation-electrique-bf-hf
 *
 * Variante BF-HF / H0-B0 (Travaux d'Ordre NON ELECTRIQUE, norme NF C 18-510 A1).
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { error: sanitizeError(err, "generating avis habilitation électrique BF-HF") },
      { status: 500 },
    );
  }
}
