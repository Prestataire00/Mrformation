/**
 * POST /api/documents/generate-avis-habilitation-electrique-b0-bf-bs
 *
 * Variante B0-BF-BS (norme NF C 18-510 A2). Body : `{ sessionId, learnerId }`.
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { error: sanitizeError(err, "generating avis habilitation électrique B0-BF-BS") },
      { status: 500 },
    );
  }
}
