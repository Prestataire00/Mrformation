/**
 * POST /api/documents/generate-avis-habilitation-electrique-bt-ht-mock
 *
 * Mock variante BT-HT (HAUTE TENSION) : Patrick ATTLAN + Habilitation
 * complète BT + HTA (norme A2).
 */
...
export async function POST(_request: NextRequest) {
  try {
    ...
    const mockSession: Session = {
      id: "mock-session-habil-bt-ht",
      entity_id: profile.entity_id,
      title: "HABILITATION HAUTE TENSION",
      ...
      planned_hours: 21,
      formation_trainers: [
        { trainer: { id: "mock-trainer-bt-ht-1", first_name: "Brigitte", last_name: "MARTINEAU", email: null, entity_id: profile.entity_id } },
      ],
    ...
    const result = await service.generate({
      ...
      docType: "avis_habilitation_electrique_bt_ht_mock",
      html: resolvedHtml,
      cacheInputs: {
        doc_type: "avis_habilitation_electrique_bt_ht_mock",
    ...
    return NextResponse.json(
      { error: sanitizeError(err, "generating mock avis habilitation BT-HT") },
      { status: 500 },
    );
  }
}
