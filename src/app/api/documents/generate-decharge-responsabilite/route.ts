/**
 * POST /api/documents/generate-decharge-responsabilite
 *
 * Génère 1 lettre de décharge de responsabilité pour 1 apprenant.
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { error: sanitizeError(err, "generating décharge responsabilité") },
      { status: 500 },
    );
  }
}
