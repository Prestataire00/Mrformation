/**
 * POST /api/documents/generate-avis-habilitation-electrique-b1v-b2v-br
 *
 * Variante B1V-B2V-BR (sans BC, norme NF C 18-510 A1).
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { error: sanitizeError(err, "generating avis habilitation électrique B1V-B2V-BR") },
      { status: 500 },
    );
  }
}
