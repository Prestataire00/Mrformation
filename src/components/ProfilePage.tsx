        ...
        <div className="bg-gray-50 border-b border-gray-200 p-6">
          <div className="flex items-center gap-4">
            ...
            <div className="relative group">
              ...
              />
              <div
                className="w-16 h-16 rounded-full overflow-hidden cursor-pointer ring-2 ring-gray-200 group-hover:ring-[#3DB5C5] transition"
              ...
              <button
                ...
                className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-[#3DB5C5] text-white flex items-center justify-center shadow-sm hover:bg-[#2da5b5] transition"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#3DB5C5]"
              />
            </div>
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-gray-700 flex items-center gap-1.5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2 pr-10 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#3DB5C5]"
                />
                <button
                  type="button"
