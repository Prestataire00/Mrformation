...
export const TEMPLATE_VARIABLES: TemplateVariable[] = [
  ...
  {
    key: "adresse_organisme",
    placeholder: "{{adresse_organisme}}",
    label: "Adresse de l'organisme",
    example: "24/26 Boulevard Gay Lussac 13014 Marseille",
    category: "autres",
    availableIn: ["document"],
  },
  {
    key: "email_organisme",
    placeholder: "{{email_organisme}}",
    label: "Email de l'organisme",
    example: "contact@mrformation.fr",
    category: "autres",
    availableIn: ["document", "email"],
  },
  {
    key: "telephone_organisme",
    placeholder: "{{telephone_organisme}}",
  ...
  {
    key: "tampon_organisme",
    placeholder: "{{tampon_organisme}}",
    label: "Tampon / cachet (image)",
    description: "Image du tampon uploadée dans les paramètres",
    example: "[Image tampon]",
    category: "autres",
    availableIn: ["document"],
  },
  {
    ...
    label: "Logo de l'organisme (image)",
    example: "[Image logo]",
    category: "autres",
    availableIn: ["document"],
  },
