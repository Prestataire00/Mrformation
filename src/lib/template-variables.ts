...
export const TEMPLATE_VARIABLES: TemplateVariable[] = [
  ...
  { key: "email_apprenant", placeholder: "[%Email de l'apprenant%]", techPlaceholder: "{{email_apprenant}}", label: "Email de l'apprenant", example: "patrick.attlan@example.fr", category: "apprenant", availableIn: ["document", "email"] },
