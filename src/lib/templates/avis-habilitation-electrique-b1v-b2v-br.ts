 ...
 * **variante B1V-B2V-BR** (sans Chargé de consignation BC).
 *
 * Document **optionnel** per (session, apprenant). 4ème variante de la
 * famille habilitation électrique. Identique à la V1 avancée mais sans BC.
 *
 * Norme NF C 18-510 A1. Symboles tableau Titre :
 *   - Non électrique : BO-H0V (Exécutant + Chargé de chantier)
 *   - Électrique     : B1 B1V, B2 B2V, BR, BE ESSAI (BC : vide)
 *
 * Durée de validité : 3 ans.
 */

export const AVIS_HABILITATION_ELECTRIQUE_B1V_B2V_BR_HTML = `<!DOCTYPE html>
<html lang="fr">
<head>
<meta charset="utf-8">
<title>Avis Habilitation Électrique — B1V-B2V-BR</title>
<style>
...
export const AVIS_HABILITATION_ELECTRIQUE_B1V_B2V_BR_FOOTER_TEMPLATE = `<div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 7.5pt; color: #6b7280; font-style: italic; width: 100%; padding: 0 16mm; text-align: center; line-height: 1.4;">
