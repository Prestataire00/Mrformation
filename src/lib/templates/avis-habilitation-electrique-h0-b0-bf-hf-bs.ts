 ...
 * **variante H0-B0-BF-HF-BS** (H0 B0 BF HF BS, sans BE Manoeuvre).
 *
 * Document **optionnel** per (session, apprenant). 6ème variante de la
 * famille habilitation électrique. Identique à B0-BF-BS (#80) mais sans
 * BE MANOEUVRE (Chargé d'opérations spécifiques vide). Norme A2.
 *
 * Symboles tableau Titre :
 *   - Exécutant Non élec  : BO-H0 / BF-HF (stackés dans la même cellule)
 *   - Chargé de chantier  : BO-H0
 *   - Exécutant élec      : BS
 *   - Autres lignes       : vides (y compris Chargé d'opérations spécifiques)
 *
 * Durée de validité : 3 ans.
 */

export const AVIS_HABILITATION_ELECTRIQUE_H0_B0_BF_HF_BS_HTML = `<!DOCTYPE html>
<html lang="fr">
<head>
<meta charset="utf-8">
<title>Avis Habilitation Électrique — H0 B0 BF HF BS</title>
<style>
...
<body>
  ...
  <!-- ════════ PAGE 2 : TITRE D'HABILITATION ÉLECTRIQUE (H0 B0 BF HF BS) ════════ -->
...
export const AVIS_HABILITATION_ELECTRIQUE_H0_B0_BF_HF_BS_FOOTER_TEMPLATE = `<div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 7.5pt; color: #6b7280; font-style: italic; width: 100%; padding: 0 16mm; text-align: center; line-height: 1.4;">
