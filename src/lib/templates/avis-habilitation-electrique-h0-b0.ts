 ...
 * **variante H0 B0 (Recyclage Non électrique uniquement)**.
 *
 * Document **optionnel** per (session, apprenant). 8ème variante de la
 * famille habilitation électrique. Norme **NF C 18-510 A2**.
 *
 * Variante minimaliste — seules les 2 lignes Non électrique sont remplies
 * avec **BO-H0V**. Toutes les lignes électriques + Habilité spécial : vides.
 *
 * Typiquement formation Recyclage pour personnel non électrique.
 *
 * Durée de validité : 3 ans.
 */

export const AVIS_HABILITATION_ELECTRIQUE_H0_B0_HTML = `<!DOCTYPE html>
<html lang="fr">
<head>
<meta charset="utf-8">
<title>Avis Habilitation Électrique — H0 B0</title>
<style>
...
export const AVIS_HABILITATION_ELECTRIQUE_H0_B0_FOOTER_TEMPLATE = `<div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 7.5pt; color: #6b7280; font-style: italic; width: 100%; padding: 0 16mm; text-align: center; line-height: 1.4;">
