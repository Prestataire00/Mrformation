 ...
 * **variante INITIAL BT** (Basse Tension).
 *
 * Document **optionnel** per (session, apprenant). 2 pages :
 *   - Page 1 : Avis après formation (texte + checkboxes Initiale/Recyclage
 *     + Favorable/Défavorable) — référence **norme NF C 18-510 A2**
 *   - Page 2 : Titre d'habilitation électrique avec **symboles INITIAL BT**
 *     (BO-H0-H0V, BS-BR, BE Manoeuvre)
 *
 * Diffère de `avis-habilitation-electrique.ts` (variante avancée B1V-B2V-BR-BC,
 * norme A1) : symboles et norme changent selon le niveau de la formation.
 *
 * Durée de validité : 3 ans.
 */

export const AVIS_HABILITATION_ELECTRIQUE_BT_HTML = `<!DOCTYPE html>
<html lang="fr">
<head>
<meta charset="utf-8">
<title>Avis Habilitation Électrique — Initial BT</title>
<style>
...
<body>
  ...
  <!-- ════════ PAGE 2 : TITRE D'HABILITATION ÉLECTRIQUE (Initial BT) ════════ -->
  ...
  <table class="titre-table">
    ...
    <tr><td class="label-col">Exécutant</td><td class="symbole-col">BO-H0-H0V</td><td class="empty-cell"></td><td class="empty-cell"></td><td class="empty-cell"></td></tr>
    <tr><td class="label-col">Chargé de chantier</td><td class="symbole-col">BO-H0-H0V</td><td class="empty-cell"></td><td class="empty-cell"></td><td class="empty-cell"></td></tr>
    ...
    <tr><td class="label-col">Chargé d'intervention BT</td><td class="symbole-col">BS-BR</td><td class="empty-cell"></td><td class="empty-cell"></td><td class="empty-cell"></td></tr>
...
export const AVIS_HABILITATION_ELECTRIQUE_BT_FOOTER_TEMPLATE = `<div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 7.5pt; color: #6b7280; font-style: italic; width: 100%; padding: 0 16mm; text-align: center; line-height: 1.4;">
