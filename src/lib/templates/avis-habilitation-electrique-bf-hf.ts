 ...
 * **variante BF-HF / H0-B0** (Travaux d'Ordre NON ELECTRIQUE).
 *
 * Document **optionnel** per (session, apprenant). 2 pages :
 *   - Page 1 : Avis après formation (texte + checkboxes Initiale/Recyclage
 *     + Favorable/Défavorable) — référence **norme NF C 18-510 A1**
 *   - Page 2 : Titre d'habilitation électrique avec **symboles BF-HF / H0-B0**
 *     uniquement sur les lignes Non électrique (le reste vide)
 *
 * 3ème variante de l'avis habilitation électrique (après V1 B1V-B2V-BR-BC
 * norme A1 et BT B0H0V/BS/BE Manoeuvre norme A2). Spécifique aux formations
 * Non électrique pures.
 *
 * Durée de validité : 3 ans.
 */

export const AVIS_HABILITATION_ELECTRIQUE_BF_HF_HTML = `<!DOCTYPE html>
<html lang="fr">
<head>
<meta charset="utf-8">
<title>Avis Habilitation Électrique — BF-HF / H0-B0</title>
<style>
...
<body>
  ...
  <!-- ════════ PAGE 2 : TITRE D'HABILITATION ÉLECTRIQUE (BF-HF / H0-B0) ════════ -->
  ...
  <table class="titre-table">
    ...
    <tr><td class="label-col">Exécutant</td><td class="symbole-col">BF-HF / H0-B0</td><td class="empty-cell"></td><td class="empty-cell"></td><td class="empty-cell"></td></tr>
    <tr><td class="label-col">Chargé de chantier</td><td class="symbole-col">BF-HF / H0-B0</td><td class="empty-cell"></td><td class="empty-cell"></td><td class="empty-cell"></td></tr>
...
export const AVIS_HABILITATION_ELECTRIQUE_BF_HF_FOOTER_TEMPLATE = `<div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 7.5pt; color: #6b7280; font-style: italic; width: 100%; padding: 0 16mm; text-align: center; line-height: 1.4;">
