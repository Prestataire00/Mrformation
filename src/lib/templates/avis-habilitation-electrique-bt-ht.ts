 ...
 * **variante BT-HT (HAUTE TENSION)**.
 *
 * Document **optionnel** per (session, apprenant). 7ème variante de la
 * famille habilitation électrique. Norme **NF C 18-510 A2**.
 *
 * Première variante à utiliser la colonne **Domaine de tension** (BT/HTA).
 * Tableau le plus complet : toutes les lignes Personnel sont remplies sauf
 * "Habilité spécial".
 *
 * Symboles + Domaine de tension :
 *   - Exécutant Non élec      : BO-H0V                       | BT HTA
 *   - Chargé de chantier      : BO-H0V                       | BT HTA
 *   - Exécutant élec          : B1 B1V / H1 H1V              | BT HTA
 *   - Chargé de travaux       : B2 B2V / H2 H2V              | BT HTA
 *   - Chargé d'intervention   : BR HR                        | BT HTA
 *   - Chargé de consignation  : BC HC                        | BT HTA
 *   - Chargé d'op. spé. BT    : BS BE MANOEUVRE / BE ESSAI   | BT
 *   - Chargé d'op. spé. HT    : HE VERIFICATION / HE ESSAI   | HTA
 *
 * Note : "Chargé d'opérations spécifiques" devient "BT" pour distinguer
 * de la ligne HT.
 *
 * Durée de validité : 3 ans.
 */

export const AVIS_HABILITATION_ELECTRIQUE_BT_HT_HTML = `<!DOCTYPE html>
<html lang="fr">
<head>
<meta charset="utf-8">
<title>Avis Habilitation Électrique — BT-HT (Haute Tension)</title>
<style>
...
<body>
  ...
  <!-- ════════ PAGE 2 : TITRE D'HABILITATION ÉLECTRIQUE (BT-HT) ════════ -->
  ...
  <table class="titre-table">
    ...
    <tr><td class="label-col">Exécutant</td><td class="symbole-col">BO-H0V</td><td class="empty-cell">BT HTA</td><td class="empty-cell"></td><td class="empty-cell"></td></tr>
    <tr><td class="label-col">Chargé de chantier</td><td class="symbole-col">BO-H0V</td><td class="empty-cell">BT HTA</td><td class="empty-cell"></td><td class="empty-cell"></td></tr>
    <tr><td colspan="5" class="section-header">Opérations d'ordre électrique</td></tr>
    <tr><td class="label-col">Exécutant</td><td class="symbole-col">B1 B1V<br>H1 H1V</td><td class="empty-cell">BT HTA</td><td class="empty-cell"></td><td class="empty-cell"></td></tr>
    <tr><td class="label-col">Chargé de travaux</td><td class="symbole-col">B2 B2V<br>H2 H2V</td><td class="empty-cell">BT HTA</td><td class="empty-cell"></td><td class="empty-cell"></td></tr>
    <tr><td class="label-col">Chargé d'intervention</td><td class="symbole-col">BR HR</td><td class="empty-cell">BT HTA</td><td class="empty-cell"></td><td class="empty-cell"></td></tr>
    <tr><td class="label-col">Chargé de consignation</td><td class="symbole-col">BC HC</td><td class="empty-cell">BT HTA</td><td class="empty-cell"></td><td class="empty-cell"></td></tr>
    <tr><td class="label-col">Chargé d'opérations spécifiques BT</td><td class="symbole-col">BS BE MANOEUVRE<br>BE ESSAI</td><td class="empty-cell">BT</td><td class="empty-cell"></td><td class="empty-cell"></td></tr>
    <tr><td class="label-col">Chargé d'opérations spécifiques HT</td><td class="symbole-col">HE VERIFICATION<br>HE ESSAI</td><td class="empty-cell">HTA</td><td class="empty-cell"></td><td class="empty-cell"></td></tr>
...
export const AVIS_HABILITATION_ELECTRIQUE_BT_HT_FOOTER_TEMPLATE = `<div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 7.5pt; color: #6b7280; font-style: italic; width: 100%; padding: 0 16mm; text-align: center; line-height: 1.4;">
