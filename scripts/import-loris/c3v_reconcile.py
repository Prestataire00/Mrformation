...
REPORT_PATH = Path(__file__).parent / "c3v_reconcile_report.json"

# Nouveaux fichiers porteurs de la clé « Code formation » (versions du client, suffixe (1))
F_SESSIONS = "Suivi_de_l_activite_.xlsx"
F_CLIENTS = "Suivi_de_l_activite__des_clients.xlsx"
F_STAGIAIRES = "Suivi_de_l_activite__des_stagiaires.xlsx"
...
# ── Réconciliation ──────────────────────────────────────────────────────────
def main():
    print(f"Réconciliation Code formation — C3V FORMATION ({C3V_ENTITY_ID})")
