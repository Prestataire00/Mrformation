...
REPORT_PATH = Path(__file__).parent / "c3v_apply_formation_companies_report.json"
...
def main():
    ...
    args = ap.parse_args()
    print(f"LOT 1b formation_companies — {'APPLY (écriture)' if args.apply else 'DRY-RUN'} — C3V FORMATION\n")
