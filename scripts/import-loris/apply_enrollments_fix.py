...
REPORT_PATH = Path(__file__).parent / "apply_enrollments_fix_report.json"
...
def main():
    ...
    db_learners = rec.rest_get_all("learners", select="id,first_name,last_name", entity_id=f"eq.{rec.MR_ENTITY_ID}")
